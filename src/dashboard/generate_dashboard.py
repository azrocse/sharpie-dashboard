...
def build_picks(raw_data):
    ...
    for market in reversed(markets):
        ...
        item = {
            ...
            "modelComparison": market.get("modelComparison"),
...
def generate_dashboard(source_json_path=None, output_dir=None):
    ...
    html_content = render_template(
        template_path,
        {
            ...
            "FIREBASE_CONFIG_JS": read_utf8(ASSETS_DIR / "js" / "firebase-config.js"),
            "USER_SETTINGS_JS": read_utf8(ASSETS_DIR / "js" / "user-settings.js"),
            "USER_SETTINGS_CSS": read_utf8(ASSETS_DIR / "css" / "user-settings.css"),
